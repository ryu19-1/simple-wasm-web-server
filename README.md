...
- wasm-auth-middleware → hello-p3 の Service Chaining 構成（`spin.toml` で定義）
- wasm-auth-middleware は公開エンドポイント、hello-p3 は private ルートとして Service Chaining 経由のみアクセス可能
...
```bash
# wasm-http-server / wasm-auth-middleware
